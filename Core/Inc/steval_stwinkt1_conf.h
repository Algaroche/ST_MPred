...
#ifndef STEVAL_STWINKT1_CONF_H
#define STEVAL_STWINKT1_CONF_H
...
/** @defgroup STEVAL_STWINKT1_CONFIG Config
  * @{
  */

/** @defgroup STEVAL_STWINKT1_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
